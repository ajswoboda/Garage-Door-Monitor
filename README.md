This is an experimental python program that provides an update when the garage door changes state. This runs on a Raspberry Pi and requires the oauth libraries to connect to gmail.
